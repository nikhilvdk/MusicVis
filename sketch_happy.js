...
function draw() {
    ...
    textSize(40);
    for(var i=1;i<10;i++){
      text(parseInt(i),(i-1)*pagex/9 + pagex/18,650);
    }
    ...
    fill("black");
    textFont("Arial");
    text("Press L for Lyrics",0,21)
    text("Press R for Reviews",0,41)
    text("Click/hover on pt to toggle valence movement/info",0,61)
    text("Press A to toggle all movement",0,81)
    pop();
